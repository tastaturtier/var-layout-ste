...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \node at ($(current page.center) - (50mm,-73mm)$) {\includegraphics[height=3.5cm]{VAR1-Cover.png}};
    ...
    \sffamily\small \textbf{Band 1: Internet-Kommunikation} (2019)
        ...
        \end{itemize}};
    \node at ($(current page.center) - (50mm,-36mm)$) {\includegraphics[height=3.5cm]{VAR2-Cover.png}};
    ...
    \sffamily\small \textbf{Band 2: API-Technologien und -Design} (geplant 2020)
        ...
        \end{itemize}};
    \node at ($(current page.center) - (50mm,1mm)$) {\includegraphics[height=3.5cm]{VAR3-Cover.png}};
    ...
    \sffamily\small \textbf{Band 3: Skalierbare Systemarchitekturen} (geplant 2021)
        ...
        \end{itemize}};
    \node at ($(current page.center) - (50mm,38mm)$) {\includegraphics[height=3.5cm]{VAR4-Cover.png}};
    ...
    \sffamily\small \textbf{Band 4: Sicherheit} (in Planung) 
        ...
        \end{itemize}};
    \node at ($(current page.center) - (50mm,75mm)$) {\includegraphics[height=3.5cm]{VAR5-Cover.png}};
