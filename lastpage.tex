...
\begin{tikzpicture}[remember picture,overlay]
    ...
    \node at ($(current page.center) - (50mm,-73mm)$) {\includegraphics[height=3.5cm]{img/VAR1-Cover.png}};
    ...
    \sffamily\small \textbf{Band 1: Internet-Kommunikation} (2019)
        ...
        \end{itemize}};
    \node at ($(current page.center) - (50mm,-36mm)$) {\includegraphics[height=3.5cm]{img/VAR2-Cover.png}};
    ...
    \sffamily\small \textbf{Band 2: API-Technologien und -Design} (geplant 2020)
        \begin{itemize}
            \item Webservices, XML/JSON-RPC, SOAP/JAX-WS, REST/JAX-RS, Swagger, CoAP
            \item Serialisierungsformate, XML, JSON, BSON, ProtocolBuffers
            \item WebSockets, HTTP/2, gRPC, verteilte Objekte, RMI, CORBA
        \end{itemize}};
    \node at ($(current page.center) - (50mm,1mm)$) {\includegraphics[height=3.5cm]{img/VAR3-Cover.png}};
    ...
    \sffamily\small \textbf{Band 3: Skalierbare Systemarchitekturen} (geplant 2021)
        ...
        \end{itemize}};
    \node at ($(current page.center) - (50mm,38mm)$) {\includegraphics[height=3.5cm]{img/VAR4-Cover.png}};
    ...
    \sffamily\small \textbf{Band 4: Sicherheit} (in Planung) 
        ...
        \end{itemize}};
    \node at ($(current page.center) - (50mm,75mm)$) {\includegraphics[height=3.5cm]{img/VAR5-Cover.png}};
